...
import com.llw.music.receiver.NotificationClickReceiver;
...
import static com.llw.music.utils.Constant.CLOSE;
import static com.llw.music.utils.Constant.NEXT;
import static com.llw.music.utils.Constant.PAUSE;
import static com.llw.music.utils.Constant.PLAY;
import static com.llw.music.utils.Constant.PREV;
import static com.llw.music.utils.Constant.PROGRESS;
...
//        manager.notify(1, notification);
    ...
    public void play(int position) {
        ...
        try {
            ...
            //设置播放音频的资源路径
            mainActivity.mediaPlayer.setDataSource(mList.get(position).path);
...
//        activityLiveData.postValue(PREV);
    ...
    public void updateNotificationShow(int position) {
        ...
        //封面专辑
//        remoteViews.setImageViewBitmap(R.id.iv_album_cover, MusicUtils.setArtwork(this, mList.get(position).getPath(),remoteViews));
        //歌曲名
